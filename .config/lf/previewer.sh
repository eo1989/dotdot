...
image_previewer() {
    ...
    # use kitty image protocol. In other situations, chafa could be used, however, lf running in
...
## for the scrollable preview code in lfrc
tail -n "+$lf_user_preview_offset" "$1"
exit 1
