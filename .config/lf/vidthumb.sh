...
# Generate the thumbnail for video (ffmpegthumbnailer is required)
# Grabbed from https://raw.githubusercontent.com/duganchen/kitty-pistol-previewer/main/vidthumb
