-- assumes both of these are loaded
local snippet_collections = {
  -- lua-snippets
  {
    dir = '/Users/eo/.config/nvim/luasnippets',
    extension = 'lua',
  },
  {
  ...
  -- snipmate-snippets
  -- this would edit snippets provided by friendly-snippets
  {
    dir = vim.fn.stdpath('data') .. '~/.local/share/nvim/lazy/friendly-snippets/snippets/',
  },
}
...
return function()
  require('luasnip.loaders').edit_snippet_files {
    ...
    format = function(path, _)
      ...
      if vim.env.HOME then path = path:gsub(vim.pesc(vim.env.HOME .. '/.config/nvim'), '$CONFIG') end
