...
"
" " Common commands
" let commands = [ 'arch', 'awk', 'b2sum', 'base32', 'base64', 'basename', 'basenc', 'bash', 'bat', 'brew', 'cat', 'chcon', 'chgrp', 'chown', 'chroot', 'cksum', 'comm', 'cp', 'csplit', 'curl', 'cut', 'date', 'dd', 'defaults', 'df', 'dir', 'dircolors', 'dirname', 'dust', 'ncdu', 'gdu', 'duf', 'exa', 'ed', 'env', 'expand', 'factor', 'fmt', 'fold', 'git', 'grep', 'groups', 'head', 'hexdump', 'hexyl', 'hostid', 'hostname', 'hugo', 'id', 'install', 'join', 'killall', 'link', 'ln', 'logname', 'md5sum', 'mkdir', 'mkfifo', 'mknod', 'mktemp', 'nice', 'nl', 'nohup', 'npm', 'nproc', 'numfmt', 'od', 'open', 'pbpaste', 'pbcopy', 'paste', 'pathchk', 'pr', 'printenv', 'printf', 'procs', 'ptx', 'readlink', 'realpath', 'rg', 'runcon', 'scutil', 'sed', 'seq', 'sha1sum', 'sha2', 'shred', 'shuf', 'split', 'stat', 'stdbuf', 'stty', 'sudo', 'sum', 'sync', 'tac', 'tee', 'terminfo', 'timeout', 'tmux', 'top', 'touch', 'tput', 'tr', 'truncate', 'tsort', 'tty', 'uname', 'unexpand', 'uniq', 'unlink', 'uptime', 'users', 'vdir', 'vim', 'wc', 'who', 'whoami', 'yabai', 'yes', 'zoxide', 'fzf', 'fd', 'ripgrep', 'rg', 'jq', 'yq', 'yt-dlp', 'timg', 'viu', 'catimg', 'watch', 'watchman', 'watchexec', 'fswatch', 'vivid', 'htop', 'gotop', 'byptop', 'btop', 'tig', 'gitui', 'gh', 'tidy-viewer', 'lazygit', 'grex' ]
"
" for i in commands
