return {
  ...
  config = function()
    ...
    ls.setup {
      ...
      update_events = { 'TextChangedI', 'InsertLeave' },
      ...
      -- require('luasnip.extras.filetype_functions'). filetype_extend('quarto', { 'markdown' }),
      -- filetype_extend('rmarkdown', { 'markdown' }),
      -- load_ft_func = require('luasnip.extras.filetype_functions').extend_load_ft {
      --   quarto = { 'markdown' },
      --   -- markdown = { 'python', 'lua', 'json', 'julia' },
      --   python = { 'ipynb' },
      -- },
    }
  ...
  --     '<A-j>',
  --     function()
  --       if not require('luasnip').expand_or_jumpable() then return '<Tab>' end
  --       require('luasnip').expand_or_jump()
  --     end,
