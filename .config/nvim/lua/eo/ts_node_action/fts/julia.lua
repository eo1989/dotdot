...
local toggle_julia_bool = function(node) return tostring(helpers.node_text(node) ~= 'true') end

local function julia_make_begin(list, prefix, suffix)
  prefix = prefix or ''
  suffix = suffix or ''
...
local function julia_trim_begin(node)
