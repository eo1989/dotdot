...
M.euporie_notebook = function(term)
  ...
  local function run_cell(on)
    -- TODO: force synchronization?
  ...
  map('n', '<C-S-Enter>', function()
    ...
    local on_exit
    -- FIXME: this doesnt make sense, need to wait for jupyter to finish executing ... probably?
